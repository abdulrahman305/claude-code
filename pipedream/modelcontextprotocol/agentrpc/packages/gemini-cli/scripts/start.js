...
const server = spawn('pnpm', ['prod:stdio'], {
  stdio: ['pipe', 'pipe', 'inherit'],
  cwd: join(root, '..', '..'),
});

const client = spawn('node', nodeArgs, { stdio: ['pipe', 'pipe', 'inherit'], env });

server.stdout.pipe(client.stdin);
client.stdout.pipe(server.stdin);
